                    ...
                    <div class="widget-rounded-circle card-box">
                        <div class="row">
                            <div class="col-12">
                                <div class="float-left">
                                    <h3 class="text-dark mt-1">
                                    <span id="paid" data-plugin="counterup">
                                    <?php
                                        echo DB::table('orders')->where('status','like','Paid')->count();
                                        ?>
                                    </span>
                                    </h3>
                            ...
                            <div class="text-md-right">
                                ...
                                <div class="btn-group dropdown ml-2 float-right">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item btn-change-status" data-status="Customer Confirm" href="#">Customer Confirm</a>
                                        <a class="dropdown-item btn-change-status"  data-status="Paid" href="#">Paid</a>
                                        <a class="dropdown-item btn-change-status" data-status="Return" href="#">Return</a>
