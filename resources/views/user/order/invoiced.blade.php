                        ...
                        <div class="text-md-right">
                            ...
                            <div class="btn-group dropdown ml-2 float-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item btn-change-status" data-status="Pending Invoiced" href="#"><i class="fe-tag mr-2 font-18 text-muted vertical-middle"></i>Pending Invoiced</a>
                                    <a class="dropdown-item btn-change-status" data-status="Invoiced" href="#"><i class="far fa-stop-circle mr-2 font-18 text-muted vertical-middle"></i>Invoiced</a>
                                    <a class="dropdown-item btn-change-status"  data-status="Stock Out" href="#"><i class="fe-tag mr-2 font-18 text-muted vertical-middle"></i>Stock Out</a>
                                </div>
                            </div>
